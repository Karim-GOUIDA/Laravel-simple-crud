...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" id="formGroupExampleInput2" placeholder="Enter Email">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="phone_number" value="<?php echo e(old('phone_number')); ?>" class="form-control" id="formGroupExampleInput2" placeholder="Enter Phone Number">
...
</html><?php /**PATH C:\Users\hp\Downloads\New folder (4)\Laravel-11-CRUD-system-main\resources\views/add-user.blade.php ENDPATH**/ ?>